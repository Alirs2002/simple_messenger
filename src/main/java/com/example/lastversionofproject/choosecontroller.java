...
public class choosecontroller {
    ...
    @FXML
    private Button messengerbutton,tutorialbutton,backbutton;

    public void gomessaging(ActionEvent event) throws IOException {
    ...
    public void gotutorial(ActionEvent event) throws IOException {
